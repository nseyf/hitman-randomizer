...
// State is initialised with the data object , the targets from the location specified as well as an active boolean
...
// Function to generate the randomised win conditions. Each press of the Randomize button
// generates a unique combination of disguises and weapons for the game.
...
render() {
  ...
  <div className="container">
    ...
    <button style={{
      ...
      marginBottom: "25px",
      height: "75px",
      textAlign: "center"}} className="btn btn-primary" onClick={this.handleClick.bind(this)}>Randomize</button>
    </div>
    <div className="row">
